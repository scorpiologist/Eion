...
public:
	...
	*/
	...
	/**
	 * Add an asset to the world. Does _not_ require BeginSet
	 */
	// TODO: Save for assets
	 ...
	 */
	void GetDiffQueues(TArray<FVoxelValueDiff>& OutValueDiffQueue, TArray<FVoxelMaterialDiff>& OutMaterialDiffQueue);
	 ...
	 * @param	ColorDiffQueue		Colors diff array; sorted by increasing Id
	 * @return	OutModifiedPositions	The modified positions
	 */
	void LoadFromDiffQueuesAndGetModifiedPositions(TArray<FVoxelValueDiff>& ValueDiffQueue, TArray<FVoxelMaterialDiff>& MaterialDiffQueue, TArray<FIntVector>& OutModifiedPositions);
