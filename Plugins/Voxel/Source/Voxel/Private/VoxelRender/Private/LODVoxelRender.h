...
private:
	...
	TArray<TArray<UHierarchicalInstancedStaticMeshComponent*, TFixedAllocator<SECTIONS_PER_CHUNK>>> GrassMeshes;
	...
	TArray<TArray<TSet<FIntVector>>> OldGrassPositionsArrayPerSection;
